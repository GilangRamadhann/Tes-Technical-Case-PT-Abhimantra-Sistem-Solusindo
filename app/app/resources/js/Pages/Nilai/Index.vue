...
<template>
    <div class="space-y-6">
        <h1 class="text-2xl font-semibold">Nilai Siswa</h1>
        ...
        <form class="grid md:grid-cols-4 gap-2" @submit.prevent="doFilter">
            ...
            <select name="mapel" class="border rounded px-3 py-2">
            ...
            <div class="p-4 bg-white rounded-xl shadow">
                ...
                <form @submit.prevent="submit" class="space-y-2">
                    ...
                    >
                        ...
                        <option v-for="s in siswas" :value="s.id" :key="s.id">
                            {{ s.nama }} ({{ s.kelas }})
                        </option>
                    </select>
                    <input
        ...
        <div class="p-4 bg-white rounded-xl shadow overflow-x-auto">
            <div class="flex items-center justify-between mb-3">
                ...
                <div class="flex gap-2">
                    <!-- pakai anchor biasa agar file download lancar -->
                    <a
                        href="/nilai/export"
